...
/*/-----GAME LOOP FUNCTIONS-----------------------------------------------------------------------------------------------------------------
class Game {
    constructor(canvasRows, canvasColums){
    ...
    gameStart() {
        ...
        //call function that generates verticals and horizontals
        this.maze.stepThroughCell(startRow, startColumn);
        //call functions taht draws maze verticals and horizontals
        this.maze.drawMazeElements();
...
document.querySelector('body').addEventListener('load', mazeGame = game.gameStart());
