//layout that is customized for the user-facing part of the application
//the goal here is to have a reuse of the HTML structure that can be shared across all user-facing pages
